...
I analyze computation, communication, and memory behavior in GNN training on the Cerebras WSE and work on improving the performance of the training pipeline.
...
My presentation in the SWoPP 2026 HPC-4 session on August 6, 2026 is titled “Execution Characteristics Analysis of Irregular GNN Training on Cerebras CS-3 Using a High-Level Workflow.” The work is co-authored with Ryohei Kobayashi.
[Program](https://swopp.github.io/2026/program/)

## Recognition

- Commit access to the LLVM Project
- AtCoder Algorithm highest rating: 2202
- Participant in the 2021 Japanese Olympiad in Informatics spring training camp
- Third place, SuperComputingContest 2019
- 23rd place, Fixstars Speed-Up Contest for Students 2026
